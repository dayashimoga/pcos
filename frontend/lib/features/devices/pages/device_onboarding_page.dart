...
class _DeviceOnboardingPageState extends State<DeviceOnboardingPage> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('Device Onboarding', style: Theme.of(context).textTheme.displayMedium),
        const SizedBox(height: 8),
        Text('Connect new devices to your PCOS cloud', style: Theme.of(context).textTheme.bodyLarge),
          ...
          child: Container(
            ...
            child: Column(children: [
              ...
              if (_onboardingCode != null) ...[
                const Text('Or enter this code manually:', style: TextStyle(fontSize: 13, color: AppTheme.textMuted)),
                  ...
                  child: Container(
                    ...
                    child: Row(mainAxisSize: MainAxisSize.min, children: [
                      Text(
                        ...
                        style: const TextStyle(fontSize: 28, fontWeight: FontWeight.w800, color: AppTheme.primary, letterSpacing: 4, fontFamily: 'monospace'),
                      ),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('Expires in ${_expirySeconds ~/ 60} min', style: const TextStyle(fontSize: 12, color: AppTheme.textMuted)),
                ]),
              ],
        ...
        Center(child: ConstrainedBox(
          ...
          child: Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              const Text('How to connect a device', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: AppTheme.textPrimary)),
              const SizedBox(height: 16),
              _InstructionStep(step: '1', title: 'Install PCOS App', subtitle: 'Download from your app store or use the web app'),
              _InstructionStep(step: '2', title: 'Scan QR or Enter Code', subtitle: 'Use the camera or enter the 6-digit code'),
              _InstructionStep(step: '3', title: 'Approve Connection', subtitle: 'Verify the device on this screen'),
              _InstructionStep(step: '4', title: 'Start Syncing', subtitle: 'Your files are now available on the new device'),
            ]),
          ),
        )),
      ]),
  ...
  Widget _buildQrPlaceholder() {
    ...
    if (_onboardingCode == null) {
      return const Center(child: Icon(Icons.qr_code_rounded, size: 80, color: Colors.black12));
    }
    return Padding(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        const SizedBox(height: 12),
        Text('PCOS', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: Colors.grey.shade700, letterSpacing: 2)),
        Text(_qrData?.replaceAll(RegExp(r'https?://'), '') ?? '',
          style: TextStyle(fontSize: 8, color: Colors.grey.shade500), overflow: TextOverflow.ellipsis, maxLines: 1),
      ]),
    );
  }
}
...
class _InstructionStep extends StatelessWidget {
  ...
  const _InstructionStep({required this.step, required this.title, required this.subtitle});
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Container(
        ...
        child: Center(child: Text(step, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.w700, color: AppTheme.primary))),
      ),
      const SizedBox(width: 12),
